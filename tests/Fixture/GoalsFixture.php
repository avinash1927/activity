...
class GoalsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'goaltype' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        'goalvalue' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => 1,
                'userid' => 1,
                'goaltype' => 'Lorem ipsum dolor sit amet',
                'goalvalue' => 'Lorem ipsum dolor sit amet',
                'created' => '2021-07-05',
                'modified' => '2021-07-05',
            ],
        ];
