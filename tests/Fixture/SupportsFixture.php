...
class SupportsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'support_category_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'user_id' => 1,
                'is_trash' => 1,
                'created' => '2021-10-02 15:45:39',
                'modified' => '2021-10-02 15:45:39',
            ],
        ];
        parent::init();
    }
