...
class SupportCategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'title' => ['type' => 'string', 'length' => 250, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'is_enable' => 1,
                'is_trash' => 1,
                'created' => '2021-10-02 15:45:28',
                'modified' => '2021-10-02 15:45:28',
            ],
        ];
        parent::init();
    }
