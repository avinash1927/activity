...
class StepsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'stepscount' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        'distance' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        'calories' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        'steps_ goal' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'steps_ goal' => 'Lorem ipsum dolor sit amet',
                'date' => '2021-08-20',
                'sdktime' => 'Lorem ipsum dolor sit amet',
                'watch_id' => 1,
                'user_id' => 1,
                'created' => '2021-08-20 14:32:12',
                'modified' => '2021-08-20 14:32:12',
            ],
        ];
        parent::init();
    }
